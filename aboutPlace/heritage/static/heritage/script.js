...
function countryPageFetch(name, coatOfArms, continents, currenciesName, currenciesSymbol, flags, languages, population){
    fetch('https://restcountries.com/v3.1/name/' + name)
    .then(response => response.json())
    .then(response => {
        console.log(response)
        ...
        var currenciesNameR = response[0].currencies[Object.keys(response[0].currencies)[0]].name
        var currenciesSymbolR = response[0].currencies[Object.keys(response[0].currencies)[0]].symbol
        ...
        coatOfArms.innerHTML = "<img src='" + coatOfArmsR + "' height='100' width='auto'>"
...
function countryPageLoad(){
    ...
    countryPageFetch(name, coatOfArms, continents, currenciesName, currenciesSymbol, flags, languages, population)
